#download tree and Upham phylogeny from https://github.com/viralemergence/batgap/01-generate_datacov
...
data$gene_targets_simplified <- revalue(data$gene_targets_simplified, c("ORF 1b"="Other","RdRp: nsP12"="RdRp","ORF SARS-Cov Tor2"="Other","UpE, Orf1a, RdRp, N"="RdRp_Other","ORF1b"="Other","RdRp "="RdRp","E, RdRp"="RdRp_Other","S1"="Other","RdRP"="RdRp","S"="Other","RdRp-1"="RdRp","RdRp-2"="RdRp","N"="Other"))
...
data$species_for_reader=revalue(data$species_for_reader,
                                c("Artibeus phaeotis"="Dermanura phaeotis",
                                  ...
                                  "Myotis aurascens Kuzyakin,Myotis petax"="Myotis aurascens,Myotis petax"))
...
#generate data.csv
write.csv(data,"~/Documents/GitHub/batgap/data.csv")
